...
setwd("C:/Users/JOE/Documents/Imperial College 2018-2019/scripts_Marta")
...
clusterExport(cl, c("transcripts", "covars","covars_trans", "foo1","foo2", "tol", "icc_trans","temp","iterations","null_icc_matrix"))
clusterEvalQ(cl, library(lme4, dplyr))


icc_trans=parSapply(cl=cl, 1:ncol(transcripts), FUN=foo1)

null_icc_matrix=t(parSapply(cl=cl, 1:ncol(transcripts), FUN=function(x) {foo2(x,iterations)}))
